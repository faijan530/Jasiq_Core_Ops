...
export async function approveIncomeUsecase(pool, { id, actorId, requestId, overrideReason }) {
  ...
  return withTransaction(pool, async (client) => {
    ...
    assertTransition({ fromStatus: current.status, toStatus: INCOME_STATUS.APPROVED });
