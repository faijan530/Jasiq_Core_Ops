...
async function addManagerAttendancePermission() {
  const pool = new Pool({ 
    connectionString: process.env.DATABASE_URL || 'postgresql://neondb_owner:npg_3H4l09IYd7fj@ep-polished-meadow-a8c5a1p4-pooler.eastus2.azure.neon.tech/neondb?sslmode=require'
  });
