...
export function HrSidebar({ open, setOpen }) {
  ...
  const navItems = [
    ...
    { id: 'ops-header', label: 'Operations', header: true },
    { id: 'ops-inbox', label: '  Inbox', path: '/hr/ops/inbox' },
    { id: 'ops-alerts', label: '  Alerts', path: '/hr/ops/alerts' },
    { id: 'ops-data-quality', label: '  Data Quality', path: '/hr/ops/data-quality' },
    { id: 'employees', label: 'Employees', path: '/hr/employees', requiredPermission: 'EMPLOYEE_READ' },
    { id: 'my-attendance', label: 'My Attendance', path: '/hr/my-attendance' },
    { id: 'team-attendance', label: 'Team Attendance', path: '/hr/attendance', requiredPermission: 'ATTENDANCE_CORRECT' },
    ...
    { id: 'audit-logs', label: 'Audit Logs', path: '/hr/audit-logs', requiredPermission: 'GOV_AUDIT_READ' }
  ];
