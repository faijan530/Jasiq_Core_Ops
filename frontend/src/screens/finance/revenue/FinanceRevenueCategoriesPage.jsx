...
export function FinanceRevenueCategoriesPage() {
      ...
      <div className="bg-white rounded-xl shadow p-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">Manage income categories.</p>
          </div>
        ...
        {rows.length === 0 ? (
          <div className="mt-6">
            <EmptyState title="No categories" description="Create your first income category." />
          </div>
        ) : (
            ...
            <div className="relative w-full max-w-lg bg-white rounded-2xl shadow-xl p-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <div className="text-sm text-slate-500 mt-1">{isEdit ? 'Edit' : 'Add'}</div>
                </div>
